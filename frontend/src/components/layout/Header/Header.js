                ...
                <div className="mt-6">
                  <nav className="grid gap-y-4">
                    <ul>
                      ...
                      <li>
                        <Link to="/" className="-m-3 flex items-center rounded-md p-3 text-sm font-semibold hover:bg-gray-50">
                          Home
                        </Link>
                      </li>
                      <li>
                        <Link to="/products" className="-m-3 flex items-center rounded-md p-3 text-sm font-semibold hover:bg-gray-50" >
                          Products
                        </Link>
                      </li>
                      <li>
                        <Link to="/about" className="-m-3 flex items-center rounded-md p-3 text-sm font-semibold hover:bg-gray-50" >
                          About Us
                        </Link>
                      </li>
                      <li>
                        <Link to="/contact" className="-m-3 flex items-center rounded-md p-3 text-sm font-semibold hover:bg-gray-50"
                        >
                          Contact Us
                        </Link>
                      </li>
